...
# -*- coding: utf-8 -*-
#
# taxi_simulator documentation build configuration file, created by
...
version = taxi_simulator.__version__
# The full version, including alpha/beta/rc tags.
release = taxi_simulator.__version__
